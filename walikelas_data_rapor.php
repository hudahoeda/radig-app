...
<style>
    ...
    .accordion-button:focus { box-shadow: 0 0 0 0.25rem rgba(38, 166, 154, 0.25); }
    .info-label { font-weight: 600; color: var(--text-dark); margin-bottom: 0.5rem; display: block; }
    .ekskul-summary-card { border: 1px solid var(--border-color); border-left: 4px solid var(--secondary-color); }
    .guidance-card { background-color: var(--bs-info-bg-subtle); border-left: 5px solid var(--bs-info); }
    .guidance-card ul { padding-left: 1.2rem; }
    .guidance-card li { margin-bottom: 0.5rem; }
</style>
...
<div class="container-fluid">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <div class="accordion" id="accordionSiswa">
                    <?php $no = 1; mysqli_data_seek($q_siswa, 0); while ($siswa = mysqli_fetch_assoc($q_siswa)) :
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            ...
                                            <div class="row g-3">
                                                <div class="col"><div class="input-group"><span class="input-group-text">Sakit</span><input type="number" name="absensi[<?php echo $id_siswa; ?>][sakit]" class="form-control" value="<?php echo $rapor_siswa['sakit'] ?? 0; ?>"></div></div>
                                                <div class="col"><div class="input-group"><span class="input-group-text">Izin</span><input type="number" name="absensi[<?php echo $id_siswa; ?>][izin]" class="form-control" value="<?php echo $rapor_siswa['izin'] ?? 0; ?>"></div></div>
                                                <div class="col"><div class="input-group"><span class="input-group-text">Alpha</span><input type="number" name="absensi[<?php echo $id_siswa; ?>][tanpa_keterangan]" class="form-control" value="<?php echo $rapor_siswa['tanpa_keterangan'] ?? 0; ?>"></div></div>
                                            </div>
                                        </div>
                                        <div>
    ...
    <?php elseif (!$id_kelas): ?>
    <div class="card shadow-sm text-center py-5"><div class="card-body"><i class="bi bi-exclamation-triangle fs-1 text-warning"></i><h3 class="mt-3">Akses Ditolak</h3><p class="text-muted">Anda tidak terdaftar sebagai wali kelas pada tahun ajaran aktif ini.</p></div></div>
    <?php else: ?>
    <div class="card shadow-sm text-center py-5"><div class="card-body"><i class="bi bi-people-fill fs-1 text-muted"></i><h3 class="mt-3">Kelas Kosong</h3><p class="text-muted">Belum ada data siswa yang ditambahkan ke kelas ini.</p></div></div>
    <?php endif; ?>
</div>
