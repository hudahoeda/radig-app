...
<head>
    <meta charset="UTF-8">
    <title>Identitas Siswa - <?php echo htmlspecialchars($siswa_identitas['nama_lengkap']); ?></title>
    <style>
...
<body>
    ...
    <div class="clearfix">
        <div class="photo-box">
            ...
            // Asumsi folder foto ada di dalam 'uploads/'. Sesuaikan jika berbeda.
            $path_relatif_foto = 'uploads/foto_siswa/' . $nama_file_foto; 
            
            if (!empty($nama_file_foto) && file_exists($path_relatif_foto)) {
                // Konversi gambar ke base64 agar bisa dirender di PDF
